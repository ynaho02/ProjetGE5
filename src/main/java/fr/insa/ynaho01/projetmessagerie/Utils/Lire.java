...
*/
//Cette fonction permet de lire les string, int, float, double, char, short entrés 
//dans la console de netbeans. Elle permet facilementde gérer une interface textuelle
